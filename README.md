...
> java -javaagent:build/libs/pddl4j-3.7.3.jar -server -Xms2048m -Xmx2048m fr.uga.pddl4j.planners.statespace.StateSpacePlannerFactory -o pddl/blocksworld/domain.pddl -f pddl/blocksworld/p15.pddl

> java -jar build/libs/pddl4j-3.7.3.jar -o pddl/blocksworld/domain.pddl -f pddl/blocksworld/p15.pddl
