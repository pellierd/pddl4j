...
public class PDDLEncoderTest {
    ...
    public void test_Encoder_IPC1998_Assembly_ADL() throws Exception {
        ...
        Tools.encodePDDLProblems(localTestPath, PDDLEncoderTest.TRACE_LEVEL);
    }
     ...
     * TO DO Check why it is too long
     * @throws Exception if something went wrong.
     */
    @Test
   ...
   /* @Test
     ...
     * TO DO Check why it is too long conditional effect expansion
     * @throws Exception if something went wrong.
     */
    @Test
