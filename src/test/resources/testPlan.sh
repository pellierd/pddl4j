...
for ((i=1 ; i<21 ; i++))
    ...
    java -javaagent:build/libs/pddl4j-${VERSION}.jar -server -Xms2048m -Xmx2048m fr.uga.pddl4j.planners.statespace.PlannerFactory -o pddl/${TYPE}/domain.pddl -f pddl/${TYPE}/${PROBLEM}
done
