(define (problem p28)
 ...
 (:htn
  :subtasks (and
   ...
   (deliver package-2 city-loc-7)
   (deliver package-3 city-loc-2)
   (deliver package-4 city-loc-18)
   (deliver package-5 city-loc-4)
   (deliver package-6 city-loc-16)
   (deliver package-7 city-loc-2)
   (deliver package-8 city-loc-6)
   (deliver package-9 city-loc-15)
   (deliver package-10 city-loc-6)
   (deliver package-11 city-loc-10)
   (deliver package-12 city-loc-0)
   (deliver package-13 city-loc-0)
   (deliver package-14 city-loc-0)
   (deliver package-15 city-loc-13)
   (deliver package-16 city-loc-15)
   (deliver package-17 city-loc-15)
   (deliver package-18 city-loc-7)
   (deliver package-19 city-loc-13)
   )
  :ordering ( )
  :constraints ( ))
 (:init
