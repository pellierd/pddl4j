(define (problem p25)
 ...
 (:htn
  :subtasks (and
   ...
   (deliver package-2 city-loc-11)
   (deliver package-3 city-loc-0)
   (deliver package-4 city-loc-4)
   (deliver package-5 city-loc-0)
   (deliver package-6 city-loc-5)
   (deliver package-7 city-loc-9)
   (deliver package-8 city-loc-5)
   (deliver package-9 city-loc-6)
   (deliver package-10 city-loc-5)
   (deliver package-11 city-loc-3)
   (deliver package-12 city-loc-11)
   (deliver package-13 city-loc-2)
   (deliver package-14 city-loc-10)
   (deliver package-15 city-loc-11)
   )
  :ordering ( )
  :constraints ( ))
 (:init
