(define
	...
	(:htn
		:ordered-subtasks (and
		    (deliver package_14 city_loc_16)
            (deliver package_11 city_loc_22)
            (deliver package_18 city_loc_11)
            (deliver package_7 city_loc_3)
            (deliver package_1 city_loc_25)
            (deliver package_5 city_loc_4)
            (deliver package_10 city_loc_10)
            (deliver package_15 city_loc_20)
            (deliver package_2 city_loc_18)
            (deliver package_19 city_loc_15)
            (deliver package_16 city_loc_13)
            (deliver package_9 city_loc_10)
            (deliver package_3 city_loc_24)
		    (deliver package_0 city_loc_4)
            (deliver package_12 city_loc_28)
            (deliver package_13 city_loc_10)
            (deliver package_8 city_loc_10)
            (deliver package_17 city_loc_11)
            (deliver package_6 city_loc_24)
