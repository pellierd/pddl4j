(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_soil_data waypoint8))
		    (task1 (get_image_data objective1 low_res))
		    (task2 (get_rock_data waypoint1))
		    (task3 (get_soil_data waypoint5))
		    (task4 (get_image_data objective1 high_res))
		    (task5 (get_soil_data waypoint0))
		    (task6 (get_soil_data waypoint2))
		    (task7 (get_rock_data waypoint2))
		    (task8 (get_rock_data waypoint8))
		    (task9 (get_soil_data waypoint10))
		)
	)
	(:init
