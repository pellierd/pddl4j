(define
	...
	(:htn
		:ordered-subtasks (and
		    ...
		    (task2 (get_image_data objective3 low_res))
		    (task3 (get_rock_data waypoint3))
            (task4(get_rock_data waypoint0))
            (task5 (get_soil_data waypoint0))
            (task6 (get_soil_data waypoint4))
            (task7 (get_rock_data waypoint4))
		    (task8 (get_soil_data waypoint6))
            (task9 (get_rock_data waypoint1))
