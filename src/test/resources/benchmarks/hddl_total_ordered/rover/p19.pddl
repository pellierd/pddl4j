(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_image_data objective5 colour))
		    (task1 (get_image_data objective7 colour))
		    (task2 (get_rock_data waypoint19))
		    (task3 (get_soil_data waypoint5))
		    (task4 (get_image_data objective4 high_res))
		    (task5 (get_image_data objective2 low_res))
		    (task6 (get_image_data objective7 low_res))
		    (task7 (get_soil_data waypoint8))
		    (task8 (get_rock_data waypoint3))
		    (task9 (get_rock_data waypoint17))
		    (task10 (get_image_data objective0 colour))
		    (task11 (get_soil_data waypoint18))
		    (task12 (get_image_data objective0 high_res))
		    (task13 (get_rock_data waypoint4))
		    (task14 (get_image_data objective6 low_res))
		    (task15 (get_rock_data waypoint6))
		    (task16 (get_rock_data waypoint9))
        )
	)
	(:init
