(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_rock_data waypoint18))
		    (task1 (get_image_data objective0 high_res))
		    (task2 (get_rock_data waypoint22))
		    (task3 (get_soil_data waypoint11))
		    (task4 (get_soil_data waypoint23))
		    (task5 (get_image_data objective5 high_res))
		    (task6 (get_rock_data waypoint21))
		    (task7 (get_image_data objective3 colour))
		    (task8 (get_rock_data waypoint16))
		    (task9 (get_image_data objective7 colour))
		    (task10 (get_soil_data waypoint8))
		    (task11 (get_soil_data waypoint13))
		    (task12 (get_rock_data waypoint9))
		    (task13 (get_soil_data waypoint7))
		    (task14 (get_rock_data waypoint12))
		    (task15 (get_rock_data waypoint7))
    		(task16 (get_image_data objective2 high_res))
    		(task17 (get_soil_data waypoint20))
    		(task18 (get_rock_data waypoint14))
    		(task19 (get_rock_data waypoint10))
        )
	)
	(:init
