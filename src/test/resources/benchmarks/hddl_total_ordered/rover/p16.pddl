(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_rock_data waypoint10))
		    (task1 (get_soil_data waypoint1))
		    (task2 (get_image_data objective0 high_res))
		    (task3 (get_rock_data waypoint5))
		    (task4 (get_image_data objective2 high_res))
		    (task5 (get_soil_data waypoint9))
		    (task6 (get_image_data objective4 high_res))
		    (task7 (get_rock_data waypoint1))
		    (task8 (get_soil_data waypoint4))
		    (task9 (get_soil_data waypoint7))
		    (task10 (get_rock_data waypoint3))
		)
	)
	(:init
