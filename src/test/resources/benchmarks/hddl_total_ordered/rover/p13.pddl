(define
	...
	(:htn
		:ordered-subtasks (and
    		(task0 (get_image_data objective3 high_res))
    		(task1 (get_rock_data waypoint7))
    		(task2 (get_soil_data waypoint5))
    		(task3 (get_rock_data waypoint4))
    		(task4 (get_rock_data waypoint8))
    		(task5 (get_image_data objective1 high_res))
    		(task6 (get_soil_data waypoint2))
    		(task7 (get_rock_data waypoint1))
    		(task8 (get_image_data objective2 high_res))
    		(task9 (get_soil_data waypoint4))
    		(task10 (get_soil_data waypoint7))
            (task11 (get_rock_data waypoint6))
		)
	)
	(:init
