(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_image_data objective3 low_res))
		    (task1 (get_rock_data waypoint6))
		    (task2 (get_rock_data waypoint4))
		    (task3 (get_soil_data waypoint0))
		    (task4 (get_image_data objective2 colour))
		    (task5 (get_rock_data waypoint7))
		    (task6 (get_soil_data waypoint14))
		    (task7 (get_image_data objective5 colour))
		    (task8 (get_image_data objective4 high_res))
            (task9 (get_rock_data waypoint2))
            (task10 (get_rock_data waypoint5))
        )
	)
	(:init
