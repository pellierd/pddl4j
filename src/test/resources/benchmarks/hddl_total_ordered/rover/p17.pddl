(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_image_data objective2 colour))
		    (task1 (get_soil_data waypoint14))
		    (task2 (get_rock_data waypoint9))
		    (task3 (get_soil_data waypoint3))
		    (task4 (get_rock_data waypoint3))
		    (task5 (get_image_data objective5 colour))
		    (task6 (get_image_data objective2 low_res))
		    (task7 (get_image_data objective4 colour))
		    (task8 (get_soil_data waypoint5))
		    (task9 (get_rock_data waypoint5))
		    (task10 (get_image_data objective3 colour))
		    (task11 (get_soil_data waypoint2))
		    (task12 (get_rock_data waypoint12))
		)
	)
	(:init
