(define
	...
	(:htn
		:ordered-subtasks (and
		    (task0 (get_rock_data waypoint6))
		    (task1 (get_image_data objective1 high_res))
		    (task2 (get_soil_data waypoint1))
            (task3 (get_rock_data waypoint7))
            (task4 (get_soil_data waypoint0))
            (task5 (get_rock_data waypoint4))
            (task6 (get_soil_data waypoint3))
		    (task7 (get_soil_data waypoint6))
		    (task8 (get_rock_data waypoint0))
	    )
	)
	(:init
