(define (problem prob)
 ...
 (:goal
     :tasks  (
            ...
            (tag t3 (do_cocktail_in_shot shot3 cocktail3))
            (tag t4 (do_cocktail_in_shot shot4 cocktail8))
            (tag t5 (do_cocktail_in_shot shot5 cocktail2))
            (tag t6 (do_cocktail_in_shot shot6 cocktail4))
            (tag t7 (do_cocktail_in_shot shot7 cocktail10))
            (tag t8 (do_cocktail_in_shot shot8 cocktail1))
