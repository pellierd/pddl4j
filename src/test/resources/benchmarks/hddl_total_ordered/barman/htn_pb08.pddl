(define (problem prob)
 ...
 (:goal
    :tasks  (
                (tag t1 (do_cocktail_in_shot shot1 cocktail9))
                ...
                (tag t5 (do_cocktail_in_shot shot5 cocktail2))
                (tag t6 (do_cocktail_in_shot shot6 cocktail1))
                (tag t7 (do_cocktail_in_shot shot7 cocktail5))
                (tag t8 (do_cocktail_in_shot shot8 cocktail3))
                (tag t9 (do_cocktail_in_shot shot9 cocktail10))
                (tag t10 (do_cocktail_in_shot shot10 cocktail4))
                (tag t11 (do_cocktail_in_shot shot11 cocktail6))
                (tag t12 (do_cocktail_in_shot shot12 cocktail10))
                (tag t13 (do_cocktail_in_shot shot13 ingredient1))
                (tag t14 (do_cocktail_in_shot shot14 ingredient1))
                (tag t15 (do_cocktail_in_shot shot15 ingredient1))
                (tag t16 (do_cocktail_in_shot shot16 cocktail3))
            )
