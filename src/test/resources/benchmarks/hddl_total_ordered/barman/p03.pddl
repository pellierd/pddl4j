...
(define (problem p03)
    ...
    (:htn
        :ordered-subtasks (and
            ...
            (serve_cocktail shot7 cocktail11)
            (serve_cocktail shot8 cocktail10)
            (serve_cocktail shot9 cocktail4)
            (serve_cocktail shot10 cocktail6)
            (serve_cocktail shot11 cocktail2)
            (serve_cocktail shot12 cocktail6)
            (serve_cocktail shot13 cocktail4)
            (serve_cocktail shot14 cocktail7)
