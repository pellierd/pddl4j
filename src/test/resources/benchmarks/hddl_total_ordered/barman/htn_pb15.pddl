(define (problem prob)
 ...
 (:goal
     :tasks  (
                (tag t1 (do_cocktail_in_shot shot1 cocktail10))
                (tag t2 (do_cocktail_in_shot shot2 cocktail9))
                ...
                (tag t8 (do_cocktail_in_shot shot8 cocktail5))
                (tag t9 (do_cocktail_in_shot shot9 cocktail2))
                (tag t10 (do_cocktail_in_shot shot10 cocktail3))
                (tag t11 (do_cocktail_in_shot shot11 cocktail11))
                (tag t12 (do_cocktail_in_shot shot12 ingredient4))
                (tag t13 (do_cocktail_in_shot shot13 cocktail1))
                (tag t14 (do_cocktail_in_shot shot14 ingredient4))
            )
