(define (problem prob)
 ...
 (:goal
    :tasks  (
            ...
            (tag t3 (do_cocktail_in_shot shot3 cocktail7))
            (tag t4 (do_cocktail_in_shot shot4 cocktail8))
            (tag t5 (do_cocktail_in_shot shot5 cocktail10))
            ...
            (tag t10 (do_cocktail_in_shot shot10 cocktail5))
            (tag t11 (do_cocktail_in_shot shot11 cocktail4))
            (tag t12 (do_cocktail_in_shot shot12 cocktail3))
            (tag t13 (do_cocktail_in_shot shot13 cocktail5))
            (tag t14 (do_cocktail_in_shot shot14 ingredient5))
            (tag t15 (do_cocktail_in_shot shot15 cocktail10))
        )
