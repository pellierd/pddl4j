(define (problem prob)
 ...
 (:goal
    :tasks  (
                (tag t1 (do_cocktail_in_shot shot1 cocktail8))
                (tag t2 (do_cocktail_in_shot shot2 cocktail9))
                (tag t3 (do_cocktail_in_shot shot3 cocktail4))
                (tag t4 (do_cocktail_in_shot shot4 cocktail3))
                (tag t5 (do_cocktail_in_shot shot5 cocktail7))
                (tag t6 (do_cocktail_in_shot shot6 cocktail5))
                (tag t7 (do_cocktail_in_shot shot7 cocktail6))
                ...
                (tag t11 (do_cocktail_in_shot shot11 cocktail1))
