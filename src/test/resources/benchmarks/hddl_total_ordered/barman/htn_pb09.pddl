(define (problem prob)
 ...
 (:goal
    :tasks  (
                ...
                (tag t6 (do_cocktail_in_shot shot6 cocktail7))
                (tag t7 (do_cocktail_in_shot shot7 cocktail4))
                (tag t8 (do_cocktail_in_shot shot8 cocktail9))
                (tag t9 (do_cocktail_in_shot shot9 cocktail2))
                (tag t10 (do_cocktail_in_shot shot10 cocktail8))
                (tag t11 (do_cocktail_in_shot shot11 ingredient2))
                (tag t12 (do_cocktail_in_shot shot12 cocktail9))
            )
