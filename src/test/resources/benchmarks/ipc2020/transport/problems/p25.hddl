(define
	...
	(:htn
		...
		:subtasks (and
		 ...
		 (task2 (deliver package_2 city_loc_11))
		 (task3 (deliver package_3 city_loc_0))
		 (task4 (deliver package_4 city_loc_4))
		 (task5 (deliver package_5 city_loc_0))
		 (task6 (deliver package_6 city_loc_5))
		 (task7 (deliver package_7 city_loc_9))
		 (task8 (deliver package_8 city_loc_5))
		 (task9 (deliver package_9 city_loc_6))
		 (task10 (deliver package_10 city_loc_5))
		 (task11 (deliver package_11 city_loc_3))
		 (task12 (deliver package_12 city_loc_11))
		 (task13 (deliver package_13 city_loc_2))
		 (task14 (deliver package_14 city_loc_10))
		 (task15 (deliver package_15 city_loc_11))
		)
		:ordering (and
			(task13 < task0)
			(task12 < task1)
	...
	(:init
		...
		(road city_loc_4 city_loc_13)
		(road city_loc_5 city_loc_3)
		(road city_loc_5 city_loc_9)
		(road city_loc_5 city_loc_12)
		...
		(at package_7 city_loc_12)
		(at package_8 city_loc_14)
		(at package_9 city_loc_7)
		(at package_10 city_loc_3)
		(at package_11 city_loc_13)
		(at package_12 city_loc_3)
		(at package_13 city_loc_5)
		(at package_14 city_loc_3)
		(at package_15 city_loc_0)
		(at truck_0 city_loc_0)
		(at truck_1 city_loc_12)
		(at truck_2 city_loc_7)
		(at truck_3 city_loc_13)
