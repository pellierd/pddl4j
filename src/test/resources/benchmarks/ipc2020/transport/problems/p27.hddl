(define
	...
	(:htn
		:parameters ()
		:subtasks (and
		 (task0 (deliver package_0 city_loc_9))
		 (task1 (deliver package_1 city_loc_0))
		 (task2 (deliver package_2 city_loc_8))
		 (task3 (deliver package_3 city_loc_6))
		 (task4 (deliver package_4 city_loc_13))
		 (task5 (deliver package_5 city_loc_9))
		 (task6 (deliver package_6 city_loc_1))
		 (task7 (deliver package_7 city_loc_8))
		 (task8 (deliver package_8 city_loc_11))
		 (task9 (deliver package_9 city_loc_12))
		 (task10 (deliver package_10 city_loc_4))
		 (task11 (deliver package_11 city_loc_1))
		 (task12 (deliver package_12 city_loc_6))
		 (task13 (deliver package_13 city_loc_0))
		 (task14 (deliver package_14 city_loc_5))
		)
		:ordering (and
			(task7 < task0)
			(task6 < task1)
	...
	(:init
		...
		(road city_loc_8 city_loc_13)
		(road city_loc_8 city_loc_14)
		...
		(at package_6 city_loc_13)
		(at package_7 city_loc_6)
		(at package_8 city_loc_5)
		(at package_9 city_loc_0)
		(at package_10 city_loc_3)
		(at package_11 city_loc_6)
		(at package_12 city_loc_8)
		(at package_13 city_loc_5)
		(at package_14 city_loc_9)
		(at truck_0 city_loc_12)
		(at truck_1 city_loc_3)
		(at truck_2 city_loc_7)
		(at truck_3 city_loc_3)
		(at truck_4 city_loc_12)
