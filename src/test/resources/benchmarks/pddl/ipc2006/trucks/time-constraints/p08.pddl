...
(:constraints (and
	(within 1857.3 (delivered package1 l1))
	(within 1857.3 (delivered package3 l1))
	(within 1114.6 (delivered package4 l2))
	(within 3459.8 (delivered package7 l3))
	(within 3459.8 (delivered package8 l2))
	(within 2097.8 (delivered package10 l1))))
