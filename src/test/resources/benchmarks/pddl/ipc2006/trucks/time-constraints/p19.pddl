...
(:constraints (and
	(within 3652.7 (delivered package1 l2))
	(within 3652.7 (delivered package2 l3))
	(within 3652.7 (delivered package3 l3))
	(within 3652.7 (delivered package4 l2))
	(within 3652.7 (delivered package5 l1))
	(within 4991.4 (delivered package6 l3))
	(within 4991.4 (delivered package7 l4))
	(within 4991.4 (delivered package9 l3))
	(within 4991.4 (delivered package10 l6))
	(within 2433.1 (delivered package12 l5))
	(within 2433.1 (delivered package13 l5))
	(within 2433.1 (delivered package14 l3))
	(within 3485.3 (delivered package16 l5))
	(within 3485.3 (delivered package19 l3))
	(within 3485.3 (delivered package20 l5))
	(within 4834.5 (delivered package21 l2))))
