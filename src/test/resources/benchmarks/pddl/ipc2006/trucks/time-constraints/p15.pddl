...
(:constraints (and
	(within 2184.0 (delivered package3 l1))
	(within 2184.0 (delivered package4 l3))
	(within 1291.6 (delivered package7 l2))
	(within 828.8 (delivered package9 l2))
	(within 828.8 (delivered package10 l4))
	(within 828.8 (delivered package12 l1))
	(within 3308.5 (delivered package15 l2))
	(within 2377.3 (delivered package17 l1))))
