...
(:constraints (and
	(within 2451.0 (delivered package1 l3))
	(within 2451.0 (delivered package2 l3))
	(within 2451.0 (delivered package3 l1))
	(within 2320.1 (delivered package5 l2))
	(within 3518.7 (delivered package7 l1))
	(within 3518.7 (delivered package9 l1))
	(within 3478.6 (delivered package10 l4))
	(within 3478.6 (delivered package11 l4))))
