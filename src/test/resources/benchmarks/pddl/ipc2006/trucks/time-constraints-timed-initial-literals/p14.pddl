...
(:init
	...
	(deliverable package3 l4)
	(deliverable package4 l2)
	(deliverable package5 l1)
	(deliverable package7 l4)
	(deliverable package8 l2)
	(deliverable package9 l4)
	(deliverable package10 l2)
	(deliverable package11 l4)
	(deliverable package12 l4)
	(deliverable package14 l3)
	(deliverable package15 l5)
	(at 2725.1 (not (deliverable package1 l2)))
	(at 2725.1 (not (deliverable package3 l4)))
	(at 2725.1 (not (deliverable package4 l2)))
	(at 1304.5 (not (deliverable package5 l1)))
	(at 1304.5 (not (deliverable package7 l4)))
	(at 1304.5 (not (deliverable package8 l2)))
	(at 2682.3 (not (deliverable package9 l4)))
	(at 2682.3 (not (deliverable package10 l2)))
	(at 2682.3 (not (deliverable package11 l4)))
	(at 2682.3 (not (deliverable package12 l4)))
	(at 3937.1 (not (deliverable package14 l3)))
	(at 3937.1 (not (deliverable package15 l5)))
