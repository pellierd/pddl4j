...
(:init
	...
	(deliverable package2 l5)
	(deliverable package3 l6)
	(deliverable package4 l2)
	(deliverable package5 l6)
	(deliverable package6 l4)
	(deliverable package7 l6)
	(deliverable package8 l1)
	(deliverable package10 l1)
	(deliverable package11 l1)
	(deliverable package12 l3)
	(deliverable package13 l1)
	(deliverable package14 l3)
	(deliverable package15 l1)
	(deliverable package16 l5)
	(deliverable package17 l4)
	(deliverable package18 l6)
	(at 3903.8 (not (deliverable package1 l1)))
	(at 3903.8 (not (deliverable package2 l5)))
	(at 3903.8 (not (deliverable package3 l6)))
	(at 3903.8 (not (deliverable package4 l2)))
	(at 3903.8 (not (deliverable package5 l6)))
	(at 2409.1 (not (deliverable package6 l4)))
	(at 2409.1 (not (deliverable package7 l6)))
	(at 2409.1 (not (deliverable package8 l1)))
	(at 2409.1 (not (deliverable package10 l1)))
	(at 2827.7 (not (deliverable package11 l1)))
	(at 2827.7 (not (deliverable package12 l3)))
	(at 2827.7 (not (deliverable package13 l1)))
	(at 2827.7 (not (deliverable package14 l3)))
	(at 2827.7 (not (deliverable package15 l1)))
	(at 1396.2 (not (deliverable package16 l5)))
	(at 1396.2 (not (deliverable package17 l4)))
	(at 1396.2 (not (deliverable package18 l6)))
