...
(:init
	...
	(= (drive-cost market1 market2) 447.00)
	(= (drive-cost market2 market1) 447.00)
	(= (drive-time market1 market2) 1341.00)
	(= (drive-time market2 market1) 1341.00)
	...
	(= (drive-cost market2 market4) 642.00)
	(= (drive-cost market4 market2) 642.00)
	(= (drive-time market2 market4) 1926.00)
	(= (drive-time market4 market2) 1926.00)
	(connected market3 market4)
	(connected market4 market3)
	(= (drive-cost market3 market4) 983.00)
	(= (drive-cost market4 market3) 983.00)
	(= (drive-time market3 market4) 2949.00)
	(= (drive-time market4 market3) 2949.00)
	(connected depot1 market2)
	(connected market2 depot1)
	(= (drive-cost market2 depot1) 165.00)
	(= (drive-cost depot1 market2) 165.00)
	(= (drive-time market2 depot1) 495.00)
	(= (drive-time depot1 market2) 495.00)
	(connected depot2 market2)
	(connected market2 depot2)
	(= (drive-cost market2 depot2) 763.00)
	(= (drive-cost depot2 market2) 763.00)
	(= (drive-time market2 depot2) 2289.00)
	(= (drive-time depot2 market2) 2289.00)
