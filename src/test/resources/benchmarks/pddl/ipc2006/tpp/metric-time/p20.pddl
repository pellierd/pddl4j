...
(:init
	...
	(= (drive-cost market1 market3) 680.00)
	(= (drive-cost market3 market1) 680.00)
	(= (drive-time market1 market3) 2040.00)
	(= (drive-time market3 market1) 2040.00)
	(connected market1 market4)
	(connected market4 market1)
	(= (drive-cost market1 market4) 845.00)
	(= (drive-cost market4 market1) 845.00)
	(= (drive-time market1 market4) 2535.00)
	(= (drive-time market4 market1) 2535.00)
	(connected market1 market5)
	(connected market5 market1)
	(= (drive-cost market1 market5) 254.00)
	(= (drive-cost market5 market1) 254.00)
	(= (drive-time market1 market5) 762.00)
	(= (drive-time market5 market1) 762.00)
	(connected market2 market3)
	(connected market3 market2)
	(= (drive-cost market2 market3) 937.00)
	(= (drive-cost market3 market2) 937.00)
	(= (drive-time market2 market3) 2811.00)
	(= (drive-time market3 market2) 2811.00)
	(connected depot1 market2)
	(connected market2 depot1)
	(= (drive-cost market2 depot1) 333.00)
	(= (drive-cost depot1 market2) 333.00)
	(= (drive-time market2 depot1) 999.00)
	(= (drive-time depot1 market2) 999.00)
	(connected depot2 market2)
	(connected market2 depot2)
	(= (drive-cost market2 depot2) 152.00)
	(= (drive-cost depot2 market2) 152.00)
	(= (drive-time market2 depot2) 456.00)
	(= (drive-time depot2 market2) 456.00)
