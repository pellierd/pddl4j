...
(:constraints (and
	...
	(forall (?t - truck)
	   (always-within 2261.00 (> (loaded goods7 ?t) 0)
	      (= (loaded goods7 ?t) 0)))

	(forall (?t - truck)
	   (always-within 1694.00 (> (loaded goods11 ?t) 0)
	      (= (loaded goods11 ?t) 0)))

	(forall (?t - truck)
	   (always-within 2261.00 (> (loaded goods8 ?t) 0)
	      (= (loaded goods8 ?t) 0)))

	(sometime-before (> (stored goods7) 0)
			 (>= (stored goods4) (request goods4)))
	(sometime-before (> (stored goods10) 0)
			 (>= (stored goods5) (request goods5)))
