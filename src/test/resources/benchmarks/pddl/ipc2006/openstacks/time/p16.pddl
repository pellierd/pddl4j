...
(define (problem os-time-wbop_30_30-20-fixed28)
        ...
        (:init (next-count n0 n1) (next-count n1 n2) (next-count n2 n3)
         ...
         (next-count n27 n28) (stacks-avail n28) (waiting o1) (includes o1 p18)
         ...
         (includes o30 p15) (includes o30 p25) (= (make-time p1) 30)
