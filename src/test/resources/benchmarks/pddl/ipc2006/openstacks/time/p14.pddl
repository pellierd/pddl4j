...
(define (problem os-time-sp4-1-fixed23)
        (:domain openstacks-time)
        (:objects n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16 n17
         n18 n19 n20 n21 n22 n23 - count o1 o2 o3 o4 o5 o6 o7 o8 o9 o10 o11 o12
         o13 o14 o15 o16 o17 o18 o19 o20 o21 o22 o23 o24 o25 - order p1 p2 p3
        ...
        (:init (next-count n0 n1) (next-count n1 n2) (next-count n2 n3)
         ...
         (next-count n21 n22) (next-count n22 n23) (stacks-avail n23)
         ...
         (includes o25 p13) (includes o25 p17) (= (make-time p1) 25)
         (= (make-time p2) 225) (= (make-time p3) 100) (= (make-time p4) 225)
         (= (make-time p5) 100) (= (make-time p6) 250) (= (make-time p7) 200)
         (= (make-time p8) 50) (= (make-time p9) 75) (= (make-time p10) 175)
         (= (make-time p11) 225) (= (make-time p12) 125)
         (= (make-time p13) 225) (= (make-time p14) 100)
         (= (make-time p15) 200) (= (make-time p16) 50) (= (make-time p17) 50)
         (= (make-time p18) 75) (= (make-time p19) 175) (= (make-time p20) 25)
         (= (make-time p21) 250) (= (make-time p22) 175)
