...
(define (problem os-complex-wbop_20_20-14)
        ...
        (:init (waiting o1) (includes o1 p16) (includes o1 p19)
         ...
         (includes o20 p20) (= (make-time p1) 20) (= (make-time p2) 180)
        ...
        (:goal
         (and (shipped o1)
              ...
              (shipped o19)
              (shipped o20)))
        (:metric minimize (+ (* 27 (max-in-use)) (total-time))))
