...
(define (problem os-complex-wbop_30_30-17)
        ...
        (:init (waiting o1) (includes o1 p9) (includes o1 p20)
         ...
         (includes o30 p19) (= (make-time p1) 30) (= (make-time p2) 270)
        ...
        (:goal
         (and (shipped o1)
              ...
              (shipped o29)
              (shipped o30)))
        (:metric minimize (+ (* 23.5 (max-in-use)) (total-time))))
