...
(define (problem os-complex-nwrssmaller4-4)
        ...
        (:init (waiting o1) (includes o1 p1) (includes o1 p5) (includes o1 p7)
         ...
         (includes o15 p24) (includes o15 p25) (= (make-time p1) 15)
         (= (make-time p2) 135) (= (make-time p3) 60) (= (make-time p4) 135)
         (= (make-time p5) 60) (= (make-time p6) 150) (= (make-time p7) 120)
         (= (make-time p8) 30) (= (make-time p9) 45) (= (make-time p10) 105)
         (= (make-time p11) 135) (= (make-time p12) 75) (= (make-time p13) 135)
         (= (make-time p14) 60) (= (make-time p15) 120) (= (make-time p16) 30)
         (= (make-time p17) 30) (= (make-time p18) 45) (= (make-time p19) 105)
         (= (make-time p20) 15) (= (make-time p21) 150) (= (make-time p22) 105)
         (= (make-time p23) 120) (= (make-time p24) 60) (= (make-time p25) 150)
        ...
        (:goal
         (and (shipped o1)
              ...
              (shipped o14)
              (shipped o15)))
        (:metric minimize (+ (* 65.5 (max-in-use)) (total-time))))
