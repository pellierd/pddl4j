...
(define (problem os-complex-nwrssmaller4-3)
        (:domain openstacks-complex)
        (:objects o1 o2 o3 o4 o5 o6 o7 o8 o9 o10 o11 o12 o13 o14 o15 - order p1
         p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15 p16 p17 p18 p19 p20
         p21 p22 p23 p24 p25 - product)
        (:init (waiting o1) (includes o1 p2) (includes o1 p9) (includes o1 p10)
         (includes o1 p12) (includes o1 p23) (includes o1 p24) (waiting o2)
         (includes o2 p3) (includes o2 p8) (includes o2 p14) (includes o2 p17)
         (includes o2 p18) (includes o2 p25) (waiting o3) (includes o3 p5)
         (includes o3 p7) (includes o3 p13) (includes o3 p16) (includes o3 p21)
         ...
         (= (make-time p25) 150) (= (stacks-in-use) 0) (= (max-in-use) 0))
        (:goal
         (and (shipped o1)
              (shipped o2)
              (shipped o3)
              ...
              (shipped o14)
              (shipped o15)))
        (:metric minimize (+ (* 55.5 (max-in-use)) (total-time))))
