...
(define (problem os-complex-nrwslarger4-3)
        (:domain openstacks-complex)
        (:objects o1 o2 o3 o4 o5 o6 o7 o8 o9 o10 o11 o12 o13 o14 o15 o16 o17
         o18 o19 o20 o21 o22 o23 o24 o25 - order p1 p2 p3 p4 p5 p6 p7 p8 p9 p10
         ...
         product)
        (:init (waiting o1) (includes o1 p4) (includes o1 p16)
         ...
         (= (make-time p1) 25) (= (make-time p2) 225) (= (make-time p3) 100)
         (= (make-time p4) 225) (= (make-time p5) 100) (= (make-time p6) 250)
         (= (make-time p7) 200) (= (make-time p8) 50) (= (make-time p9) 75)
         (= (make-time p10) 175) (= (make-time p11) 225)
         (= (make-time p12) 125) (= (make-time p13) 225)
         (= (make-time p14) 100) (= (make-time p15) 200) (= (make-time p16) 50)
         (= (make-time p17) 50) (= (make-time p18) 75) (= (make-time p19) 175)
         (= (make-time p20) 25) (= (make-time p21) 250) (= (make-time p22) 175)
         (= (make-time p23) 200) (= (make-time p24) 100)
         (= (make-time p25) 250) (= (make-time p26) 150)
         (= (make-time p27) 225) (= (make-time p28) 250)
         (= (make-time p29) 175) (= (make-time p30) 200)
         (= (make-time p31) 250) (= (make-time p32) 75) (= (make-time p33) 50)
         (= (make-time p34) 75) (= (make-time p35) 125) (= (make-time p36) 125)
         (= (make-time p37) 100) (= (make-time p38) 250)
         (= (make-time p39) 175) (= (make-time p40) 175)
         (= (make-time p41) 100) (= (make-time p42) 75) (= (make-time p43) 175)
         (= (make-time p44) 100) (= (make-time p45) 50) (= (make-time p46) 225)
         (= (make-time p47) 250) (= (make-time p48) 150)
         (= (make-time p49) 175) (= (make-time p50) 50) (= (make-time p51) 100)
         (= (make-time p52) 175) (= (make-time p53) 200)
         (= (make-time p54) 225) (= (make-time p55) 100) (= (make-time p56) 25)
         (= (make-time p57) 25) (= (make-time p58) 225) (= (make-time p59) 200)
         (= (make-time p60) 175) (= (stacks-in-use) 0) (= (max-in-use) 0))
        (:goal
         (and (shipped o1)
              (shipped o2)
              (shipped o3)
              ...
              (shipped o24)
              (shipped o25)))
        (:metric minimize (+ (* 35.3 (max-in-use)) (total-time))))
