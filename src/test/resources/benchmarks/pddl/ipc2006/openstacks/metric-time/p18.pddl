...
(define (problem os-complex-wbop_30_30-37)
        ...
        (:init (waiting o1) (includes o1 p13) (includes o1 p15)
         ...
         (= (make-time p1) 30) (= (make-time p2) 270) (= (make-time p3) 120)
         (= (make-time p4) 270) (= (make-time p5) 120) (= (make-time p6) 300)
         (= (make-time p7) 240) (= (make-time p8) 60) (= (make-time p9) 90)
         (= (make-time p10) 210) (= (make-time p11) 270)
        ...
        (:goal
         (and (shipped o1)
              ...
              (shipped o29)
              (shipped o30)))
        (:metric minimize (+ (* 101.0 (max-in-use)) (total-time))))
