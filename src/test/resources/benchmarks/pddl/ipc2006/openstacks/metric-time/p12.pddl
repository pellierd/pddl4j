...
(define (problem os-complex-nrwslarger4-1)
        ...
        (:init (waiting o1) (includes o1 p5) (includes o1 p6) (includes o1 p7)
         ...
         (= (make-time p30) 160) (= (stacks-in-use) 0) (= (max-in-use) 0))
        (:goal
         (and (shipped o1)
              (shipped o2)
              (shipped o3)
              ...
              (shipped o19)
              (shipped o20)))
        (:metric minimize (+ (* 88.0 (max-in-use)) (total-time))))
