(define (problem elevators-time-p24_43_1)
...
(= (travel-slow n0 n1) 12) (= (travel-slow n0 n2) 20) (= (travel-slow n0 n3) 28) (= (travel-slow n0 n4) 36) (= (travel-slow n0 n5) 44) (= (travel-slow n0 n6) 52) (= (travel-slow n1 n2) 12) (= (travel-slow n1 n3) 20) (= (travel-slow n1 n4) 28) (= (travel-slow n1 n5) 36) (= (travel-slow n1 n6) 44) (= (travel-slow n2 n3) 12) (= (travel-slow n2 n4) 20) (= (travel-slow n2 n5) 28) (= (travel-slow n2 n6) 36) (= (travel-slow n3 n4) 12) (= (travel-slow n3 n5) 20) (= (travel-slow n3 n6) 28) (= (travel-slow n4 n5) 12) (= (travel-slow n4 n6) 20) (= (travel-slow n5 n6) 12) 

(= (travel-slow n6 n7) 12) (= (travel-slow n6 n8) 20) (= (travel-slow n6 n9) 28) (= (travel-slow n6 n10) 36) (= (travel-slow n6 n11) 44) (= (travel-slow n6 n12) 52) (= (travel-slow n7 n8) 12) (= (travel-slow n7 n9) 20) (= (travel-slow n7 n10) 28) (= (travel-slow n7 n11) 36) (= (travel-slow n7 n12) 44) (= (travel-slow n8 n9) 12) (= (travel-slow n8 n10) 20) (= (travel-slow n8 n11) 28) (= (travel-slow n8 n12) 36) (= (travel-slow n9 n10) 12) (= (travel-slow n9 n11) 20) (= (travel-slow n9 n12) 28) (= (travel-slow n10 n11) 12) (= (travel-slow n10 n12) 20) (= (travel-slow n11 n12) 12) 

(= (travel-slow n12 n13) 12) (= (travel-slow n12 n14) 20) (= (travel-slow n12 n15) 28) (= (travel-slow n12 n16) 36) (= (travel-slow n12 n17) 44) (= (travel-slow n12 n18) 52) (= (travel-slow n13 n14) 12) (= (travel-slow n13 n15) 20) (= (travel-slow n13 n16) 28) (= (travel-slow n13 n17) 36) (= (travel-slow n13 n18) 44) (= (travel-slow n14 n15) 12) (= (travel-slow n14 n16) 20) (= (travel-slow n14 n17) 28) (= (travel-slow n14 n18) 36) (= (travel-slow n15 n16) 12) (= (travel-slow n15 n17) 20) (= (travel-slow n15 n18) 28) (= (travel-slow n16 n17) 12) (= (travel-slow n16 n18) 20) (= (travel-slow n17 n18) 12) 

(= (travel-slow n18 n19) 12) (= (travel-slow n18 n20) 20) (= (travel-slow n18 n21) 28) (= (travel-slow n18 n22) 36) (= (travel-slow n18 n23) 44) (= (travel-slow n18 n24) 52) (= (travel-slow n19 n20) 12) (= (travel-slow n19 n21) 20) (= (travel-slow n19 n22) 28) (= (travel-slow n19 n23) 36) (= (travel-slow n19 n24) 44) (= (travel-slow n20 n21) 12) (= (travel-slow n20 n22) 20) (= (travel-slow n20 n23) 28) (= (travel-slow n20 n24) 36) (= (travel-slow n21 n22) 12) (= (travel-slow n21 n23) 20) (= (travel-slow n21 n24) 28) (= (travel-slow n22 n23) 12) (= (travel-slow n22 n24) 20) (= (travel-slow n23 n24) 12) 


(= (travel-fast n0 n3) 12) (= (travel-fast n0 n6) 15) (= (travel-fast n0 n9) 18) (= (travel-fast n0 n12) 20) (= (travel-fast n0 n15) 22) (= (travel-fast n0 n18) 23) (= (travel-fast n0 n21) 25) (= (travel-fast n0 n24) 26) 

(= (travel-fast n3 n6) 12) (= (travel-fast n3 n9) 15) (= (travel-fast n3 n12) 18) (= (travel-fast n3 n15) 20) (= (travel-fast n3 n18) 22) (= (travel-fast n3 n21) 23) (= (travel-fast n3 n24) 25) 

(= (travel-fast n6 n9) 12) (= (travel-fast n6 n12) 15) (= (travel-fast n6 n15) 18) (= (travel-fast n6 n18) 20) (= (travel-fast n6 n21) 22) (= (travel-fast n6 n24) 23) 

(= (travel-fast n9 n12) 12) (= (travel-fast n9 n15) 15) (= (travel-fast n9 n18) 18) (= (travel-fast n9 n21) 20) (= (travel-fast n9 n24) 22) 

(= (travel-fast n12 n15) 12) (= (travel-fast n12 n18) 15) (= (travel-fast n12 n21) 18) (= (travel-fast n12 n24) 20) 

(= (travel-fast n15 n18) 12) (= (travel-fast n15 n21) 15) (= (travel-fast n15 n24) 18) 

(= (travel-fast n18 n21) 12) (= (travel-fast n18 n24) 15) 

(= (travel-fast n21 n24) 12) 
