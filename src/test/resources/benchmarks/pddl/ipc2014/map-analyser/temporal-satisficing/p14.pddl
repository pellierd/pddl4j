...
(=(distance junction0-0 junction0-1) 66)
(=(distance junction0-1 junction0-0) 66)
(connected junction0-1 junction0-2)
(connected junction0-2 junction0-1)
(=(distance junction0-1 junction0-2) 20)
(=(distance junction0-2 junction0-1) 20)
(connected junction0-2 junction0-3)
(connected junction0-3 junction0-2)
(=(distance junction0-2 junction0-3) 48)
(=(distance junction0-3 junction0-2) 48)
(connected junction0-3 junction0-4)
(connected junction0-4 junction0-3)
(=(distance junction0-3 junction0-4) 16)
(=(distance junction0-4 junction0-3) 16)
(connected junction1-0 junction1-1)
(connected junction1-1 junction1-0)
(=(distance junction1-0 junction1-1) 98)
(=(distance junction1-1 junction1-0) 98)
(connected junction1-1 junction1-2)
(connected junction1-2 junction1-1)
(=(distance junction1-1 junction1-2) 56)
(=(distance junction1-2 junction1-1) 56)
(connected junction1-2 junction1-3)
(connected junction1-3 junction1-2)
(=(distance junction1-2 junction1-3) 7)
(=(distance junction1-3 junction1-2) 7)
(connected junction1-3 junction1-4)
(connected junction1-4 junction1-3)
(=(distance junction1-3 junction1-4) 44)
(=(distance junction1-4 junction1-3) 44)
...
(=(distance junction2-2 junction2-3) 15)
(=(distance junction2-3 junction2-2) 15)
(connected junction2-3 junction2-4)
(connected junction2-4 junction2-3)
(=(distance junction2-3 junction2-4) 80)
(=(distance junction2-4 junction2-3) 80)
...
(=(distance junction3-1 junction3-2) 91)
(=(distance junction3-2 junction3-1) 91)
(connected junction3-2 junction3-3)
(connected junction3-3 junction3-2)
(=(distance junction3-2 junction3-3) 10)
(=(distance junction3-3 junction3-2) 10)
(connected junction3-3 junction3-4)
(connected junction3-4 junction3-3)
(=(distance junction3-3 junction3-4) 5)
(=(distance junction3-4 junction3-3) 5)
(connected junction4-0 junction4-1)
(connected junction4-1 junction4-0)
(=(distance junction4-0 junction4-1) 33)
(=(distance junction4-1 junction4-0) 33)
(connected junction4-1 junction4-2)
(connected junction4-2 junction4-1)
(=(distance junction4-1 junction4-2) 96)
(=(distance junction4-2 junction4-1) 96)
(connected junction4-2 junction4-3)
(connected junction4-3 junction4-2)
(=(distance junction4-2 junction4-3) 96)
(=(distance junction4-3 junction4-2) 96)
(connected junction4-3 junction4-4)
(connected junction4-4 junction4-3)
(=(distance junction4-3 junction4-4) 3)
(=(distance junction4-4 junction4-3) 3)
...
(=(distance junction1-0 junction2-0) 75)
(=(distance junction2-0 junction1-0) 75)
(connected junction2-0 junction3-0)
(connected junction3-0 junction2-0)
(=(distance junction2-0 junction3-0) 75)
(=(distance junction3-0 junction2-0) 75)
(connected junction3-0 junction4-0)
(connected junction4-0 junction3-0)
(=(distance junction3-0 junction4-0) 10)
(=(distance junction4-0 junction3-0) 10)
(connected junction0-1 junction1-1)
(connected junction1-1 junction0-1)
(=(distance junction0-1 junction1-1) 36)
(=(distance junction1-1 junction0-1) 36)
(connected junction1-1 junction2-1)
(connected junction2-1 junction1-1)
(=(distance junction1-1 junction2-1) 15)
(=(distance junction2-1 junction1-1) 15)
(connected junction2-1 junction3-1)
(connected junction3-1 junction2-1)
(=(distance junction2-1 junction3-1) 93)
(=(distance junction3-1 junction2-1) 93)
(connected junction3-1 junction4-1)
(connected junction4-1 junction3-1)
(=(distance junction3-1 junction4-1) 28)
(=(distance junction4-1 junction3-1) 28)
...
(=(distance junction1-2 junction2-2) 89)
(=(distance junction2-2 junction1-2) 89)
(connected junction2-2 junction3-2)
(connected junction3-2 junction2-2)
(=(distance junction2-2 junction3-2) 58)
(=(distance junction3-2 junction2-2) 58)
(connected junction3-2 junction4-2)
(connected junction4-2 junction3-2)
(=(distance junction3-2 junction4-2) 4)
(=(distance junction4-2 junction3-2) 4)
(connected junction0-3 junction1-3)
(connected junction1-3 junction0-3)
(=(distance junction0-3 junction1-3) 46)
(=(distance junction1-3 junction0-3) 46)
(connected junction1-3 junction2-3)
(connected junction2-3 junction1-3)
(=(distance junction1-3 junction2-3) 65)
(=(distance junction2-3 junction1-3) 65)
(connected junction2-3 junction3-3)
(connected junction3-3 junction2-3)
(=(distance junction2-3 junction3-3) 25)
(=(distance junction3-3 junction2-3) 25)
(connected junction3-3 junction4-3)
(connected junction4-3 junction3-3)
(=(distance junction3-3 junction4-3) 97)
(=(distance junction4-3 junction3-3) 97)
(connected junction0-4 junction1-4)
(connected junction1-4 junction0-4)
(=(distance junction0-4 junction1-4) 59)
(=(distance junction1-4 junction0-4) 59)
(connected junction1-4 junction2-4)
(connected junction2-4 junction1-4)
(=(distance junction1-4 junction2-4) 97)
(=(distance junction2-4 junction1-4) 97)
(connected junction2-4 junction3-4)
(connected junction3-4 junction2-4)
(=(distance junction2-4 junction3-4) 8)
(=(distance junction3-4 junction2-4) 8)
(connected junction3-4 junction4-4)
(connected junction4-4 junction3-4)
(=(distance junction3-4 junction4-4) 20)
(=(distance junction4-4 junction3-4) 20)
(clear junction0-0)
(clear junction0-1)
(clear junction0-2)
(clear junction0-3)
