...
(=(distance junction0-0 junction0-1) 69)
(=(distance junction0-1 junction0-0) 69)
(connected junction0-1 junction0-2)
(connected junction0-2 junction0-1)
(=(distance junction0-1 junction0-2) 88)
(=(distance junction0-2 junction0-1) 88)
...
(=(distance junction0-3 junction0-4) 25)
(=(distance junction0-4 junction0-3) 25)
(connected junction1-0 junction1-1)
(connected junction1-1 junction1-0)
(=(distance junction1-0 junction1-1) 25)
(=(distance junction1-1 junction1-0) 25)
(connected junction1-1 junction1-2)
(connected junction1-2 junction1-1)
(=(distance junction1-1 junction1-2) 63)
(=(distance junction1-2 junction1-1) 63)
(connected junction1-2 junction1-3)
(connected junction1-3 junction1-2)
(=(distance junction1-2 junction1-3) 28)
(=(distance junction1-3 junction1-2) 28)
(connected junction1-3 junction1-4)
(connected junction1-4 junction1-3)
(=(distance junction1-3 junction1-4) 13)
(=(distance junction1-4 junction1-3) 13)
(connected junction2-0 junction2-1)
(connected junction2-1 junction2-0)
(=(distance junction2-0 junction2-1) 48)
(=(distance junction2-1 junction2-0) 48)
(connected junction2-1 junction2-2)
(connected junction2-2 junction2-1)
(=(distance junction2-1 junction2-2) 99)
(=(distance junction2-2 junction2-1) 99)
(connected junction2-2 junction2-3)
(connected junction2-3 junction2-2)
(=(distance junction2-2 junction2-3) 55)
(=(distance junction2-3 junction2-2) 55)
(connected junction2-3 junction2-4)
(connected junction2-4 junction2-3)
(=(distance junction2-3 junction2-4) 7)
(=(distance junction2-4 junction2-3) 7)
(connected junction3-0 junction3-1)
(connected junction3-1 junction3-0)
(=(distance junction3-0 junction3-1) 35)
(=(distance junction3-1 junction3-0) 35)
(connected junction3-1 junction3-2)
(connected junction3-2 junction3-1)
(=(distance junction3-1 junction3-2) 72)
(=(distance junction3-2 junction3-1) 72)
(connected junction3-2 junction3-3)
(connected junction3-3 junction3-2)
(=(distance junction3-2 junction3-3) 4)
(=(distance junction3-3 junction3-2) 4)
(connected junction3-3 junction3-4)
(connected junction3-4 junction3-3)
(=(distance junction3-3 junction3-4) 52)
(=(distance junction3-4 junction3-3) 52)
...
(=(distance junction4-1 junction4-2) 83)
(=(distance junction4-2 junction4-1) 83)
(connected junction4-2 junction4-3)
(connected junction4-3 junction4-2)
(=(distance junction4-2 junction4-3) 28)
(=(distance junction4-3 junction4-2) 28)
...
(=(distance junction0-0 junction1-0) 46)
(=(distance junction1-0 junction0-0) 46)
(connected junction1-0 junction2-0)
(connected junction2-0 junction1-0)
(=(distance junction1-0 junction2-0) 64)
(=(distance junction2-0 junction1-0) 64)
(connected junction2-0 junction3-0)
(connected junction3-0 junction2-0)
(=(distance junction2-0 junction3-0) 96)
(=(distance junction3-0 junction2-0) 96)
(connected junction3-0 junction4-0)
(connected junction4-0 junction3-0)
(=(distance junction3-0 junction4-0) 40)
(=(distance junction4-0 junction3-0) 40)
...
(=(distance junction2-1 junction3-1) 31)
(=(distance junction3-1 junction2-1) 31)
...
(=(distance junction1-2 junction2-2) 12)
(=(distance junction2-2 junction1-2) 12)
(connected junction2-2 junction3-2)
(connected junction3-2 junction2-2)
(=(distance junction2-2 junction3-2) 74)
(=(distance junction3-2 junction2-2) 74)
(connected junction3-2 junction4-2)
(connected junction4-2 junction3-2)
(=(distance junction3-2 junction4-2) 36)
(=(distance junction4-2 junction3-2) 36)
(connected junction0-3 junction1-3)
(connected junction1-3 junction0-3)
(=(distance junction0-3 junction1-3) 42)
(=(distance junction1-3 junction0-3) 42)
...
(=(distance junction2-3 junction3-3) 7)
(=(distance junction3-3 junction2-3) 7)
(connected junction3-3 junction4-3)
(connected junction4-3 junction3-3)
(=(distance junction3-3 junction4-3) 3)
(=(distance junction4-3 junction3-3) 3)
(connected junction0-4 junction1-4)
(connected junction1-4 junction0-4)
(=(distance junction0-4 junction1-4) 16)
(=(distance junction1-4 junction0-4) 16)
...
(=(distance junction2-4 junction3-4) 27)
(=(distance junction3-4 junction2-4) 27)
(connected junction3-4 junction4-4)
(connected junction4-4 junction3-4)
(=(distance junction3-4 junction4-4) 6)
(=(distance junction4-4 junction3-4) 6)
(clear junction0-0)
(clear junction0-1)
(clear junction0-2)
(clear junction0-3)
