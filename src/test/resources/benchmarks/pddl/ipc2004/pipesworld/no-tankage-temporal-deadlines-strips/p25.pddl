...
(define (problem p27-net3-b18-g6_dt0_instance)
  ...
  (:init
    ...
    ;; deadlines for goal batches
      ...
      (at 12.14 (not (deliverable B17)))
      ;; Plan delivery time is 17.07
      (at 17.17 (not (deliverable B4)))
      ;; Plan delivery time is 16.07
      (at 16.17 (not (deliverable B6)))
      ;; Plan delivery time is 16.07
      (at 16.17 (not (deliverable B11)))
      ;; Plan delivery time is 15.07
      (at 15.17 (not (deliverable B1)))
      ;; Plan delivery time is 17.07
      (at 17.17 (not (deliverable B3)))
