...
(define (problem p24-net3-b14-g5_dt0_instance)
  ...
  (:init
    ...
    ;; deadlines for goal batches
      ...
      (at 14.16 (not (deliverable B4)))
      ;; Plan delivery time is 23.11
      (at 23.21 (not (deliverable B7)))
      ;; Plan delivery time is 14.06
      (at 22.16 (not (deliverable B12)))
      ;; Plan delivery time is 13.06
      (at 15.16 (not (deliverable B9)))
      ;; Plan delivery time is 8.03
      (at 14.13 (not (deliverable B11)))
