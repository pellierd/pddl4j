...
(define (problem p19-net2-b18-g6_dt0_instance)
  ...
  (:init
    ...
    ;; deadlines for goal batches
      ...
      (at 5.1 (not (deliverable B15)))
      ;; Plan delivery time is 1
      (at 1.1 (not (deliverable B2)))
      ;; Plan delivery time is 11.04
      (at 11.14 (not (deliverable B5)))
      ;; Plan delivery time is 4.01
      (at 9.11 (not (deliverable B7)))
      ;; Plan delivery time is 8.03
      (at 9.13 (not (deliverable B12)))
      ;; Plan delivery time is 7.03
      (at 9.13 (not (deliverable B3)))
