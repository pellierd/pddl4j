...
(define (problem p17-net2-b16-g5_dt0_instance)
  ...
  (:init
    ...
    ;; deadlines for goal batches
      ...
      (at 10.13 (not (deliverable B10)))
      ;; Plan delivery time is 7.02
      (at 8.12 (not (deliverable B14)))
      ;; Plan delivery time is 2
      (at 2.1 (not (deliverable B15)))
      ;; Plan delivery time is 6.01
      (at 8.11 (not (deliverable B0)))
      ;; Plan delivery time is 1
      (at 7.1 (not (deliverable B1)))
