...
(:init
	...
	(= (slew_time Phenomenon8 Phenomenon9) 65.52)
        ...
        (at 92.00 (visible antenna0 satellite1))
        (at 172.04 (not (visible antenna0 satellite1)))
        (at 92.00 (visible antenna0 satellite0))
        (at 172.04 (not (visible antenna0 satellite0)))
        (at 149.00 (visible antenna1 satellite1))
        (at 229.04 (not (visible antenna1 satellite1)))
