...
(:init
	...
	(= (slew_time Star23 Phenomenon24) 65.92)
        ...
        (at 53.00 (visible antenna0 satellite2))
        (at 133.04 (not (visible antenna0 satellite2)))
        (at 53.00 (visible antenna0 satellite1))
        (at 133.04 (not (visible antenna0 satellite1)))
        (at 53.00 (visible antenna0 satellite3))
        (at 133.04 (not (visible antenna0 satellite3)))
        (at 82.00 (visible antenna1 satellite1))
        (at 162.04 (not (visible antenna1 satellite1)))
        (at 82.00 (visible antenna1 satellite4))
        (at 162.04 (not (visible antenna1 satellite4)))
        (at 103.00 (visible antenna2 satellite1))
        (at 183.04 (not (visible antenna2 satellite1)))
        (at 103.00 (visible antenna2 satellite4))
        (at 183.04 (not (visible antenna2 satellite4)))
        (at 201.00 (visible antenna0 satellite0))
        (at 281.04 (not (visible antenna0 satellite0)))
        (at 201.00 (visible antenna0 satellite1))
        (at 281.04 (not (visible antenna0 satellite1)))
        (at 237.00 (visible antenna1 satellite1))
        (at 317.04 (not (visible antenna1 satellite1)))
