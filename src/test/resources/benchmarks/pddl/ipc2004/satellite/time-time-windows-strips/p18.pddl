...
(:init
	...
	(= (slew_time Planet23 Phenomenon24) 11.27)
        ...
        (at 42.00 (visible antenna0 satellite2))
        (at 122.04 (not (visible antenna0 satellite2)))
        (at 42.00 (visible antenna0 satellite0))
        (at 122.04 (not (visible antenna0 satellite0)))
        (at 42.00 (visible antenna0 satellite4))
        (at 122.04 (not (visible antenna0 satellite4)))
        (at 57.00 (visible antenna1 satellite0))
        (at 137.04 (not (visible antenna1 satellite0)))
        (at 57.00 (visible antenna1 satellite2))
        (at 137.04 (not (visible antenna1 satellite2)))
        (at 57.00 (visible antenna1 satellite1))
        (at 137.04 (not (visible antenna1 satellite1)))
        (at 74.00 (visible antenna2 satellite2))
        (at 154.04 (not (visible antenna2 satellite2)))
        (at 74.00 (visible antenna2 satellite0))
        (at 154.04 (not (visible antenna2 satellite0)))
        (at 74.00 (visible antenna2 satellite1))
        (at 154.04 (not (visible antenna2 satellite1)))
        (at 79.00 (visible antenna3 satellite3))
        (at 159.04 (not (visible antenna3 satellite3)))
