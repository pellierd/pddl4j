...
(:init
	...
	(= (slew_time Phenomenon13 Star14) 0.2689)
        ...
        (at 57.00 (visible antenna0 satellite2))
        (at 137.04 (not (visible antenna0 satellite2)))
        (at 57.00 (visible antenna0 satellite4))
        (at 137.04 (not (visible antenna0 satellite4)))
        (at 79.00 (visible antenna1 satellite1))
        (at 159.04 (not (visible antenna1 satellite1)))
        (at 79.00 (visible antenna1 satellite4))
        (at 159.04 (not (visible antenna1 satellite4)))
        (at 134.00 (visible antenna2 satellite3))
        (at 214.04 (not (visible antenna2 satellite3)))
        (at 134.00 (visible antenna2 satellite0))
        (at 214.04 (not (visible antenna2 satellite0)))
