...
(:init
	...
	(= (slew_time Phenomenon13 Phenomenon14) 2.715)
        ...
        (at 77.00 (visible antenna1 satellite0))
        (at 157.04 (not (visible antenna1 satellite0)))
        (at 77.00 (visible antenna1 satellite2))
        (at 157.04 (not (visible antenna1 satellite2)))
        (at 77.00 (visible antenna1 satellite3))
        (at 157.04 (not (visible antenna1 satellite3)))
        (at 80.00 (visible antenna2 satellite0))
        (at 160.04 (not (visible antenna2 satellite0)))
        (at 80.00 (visible antenna2 satellite1))
        (at 160.04 (not (visible antenna2 satellite1)))
