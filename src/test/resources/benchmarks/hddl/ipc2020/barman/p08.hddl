...
(define (problem p08)
    ...
    (:htn
        :ordered-subtasks (and
            (serve_cocktail shot1 cocktail9)
            (serve_cocktail shot2 cocktail7)
            (serve_cocktail shot3 cocktail11)
            (serve_cocktail shot4 cocktail8)
            (serve_cocktail shot5 cocktail2)
            (serve_cocktail shot6 cocktail1)
            (serve_cocktail shot7 cocktail5)
            (serve_cocktail shot8 cocktail3)
            (serve_cocktail shot9 cocktail10)
            (serve_cocktail shot10 cocktail4)
            (serve_cocktail shot11 cocktail6)
            (serve_cocktail shot12 cocktail10)
            (serve_shot shot13 ingredient1)
            (serve_shot shot14 ingredient1)
            (serve_shot shot15 ingredient1)
            (serve_cocktail shot16 cocktail3)
        )
    )
