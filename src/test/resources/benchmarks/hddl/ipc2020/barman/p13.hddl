...
(define (problem p13)
    ...
    (:htn
        :ordered-subtasks (and
            ...
            (serve_cocktail shot2 cocktail4)
            (serve_cocktail shot3 cocktail10)
            (serve_cocktail shot4 cocktail9)
            (serve_cocktail shot5 cocktail5)
            (serve_cocktail shot6 cocktail6)
            (serve_cocktail shot7 cocktail1)
            (serve_cocktail shot8 cocktail8)
            (serve_cocktail shot9 cocktail7)
            (serve_cocktail shot10 cocktail3)
            (serve_cocktail shot11 cocktail2)
            (serve_cocktail shot12 cocktail3)
            (serve_cocktail shot13 cocktail3)
            (serve_cocktail shot14 cocktail1)
            (serve_shot shot15 ingredient2)
            (serve_cocktail shot16 cocktail6)
        )
    )
