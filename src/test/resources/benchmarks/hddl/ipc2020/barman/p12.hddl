...
(define (problem p12)
    ...
    (:htn
        :ordered-subtasks (and
            ...
            (serve_cocktail shot3 cocktail5)
            (serve_cocktail shot4 cocktail4)
            (serve_cocktail shot5 cocktail1)
            (serve_cocktail shot6 cocktail6)
            (serve_cocktail shot7 cocktail3)
            (serve_cocktail shot8 cocktail11)
            (serve_cocktail shot9 cocktail8)
            (serve_cocktail shot10 cocktail2)
            (serve_cocktail shot11 cocktail9)
            (serve_cocktail shot12 cocktail7)
            (serve_cocktail shot13 cocktail7)
            (serve_cocktail shot14 cocktail2)
            (serve_cocktail shot15 cocktail9)
        )
    )
