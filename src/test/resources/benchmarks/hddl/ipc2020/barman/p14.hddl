...
(define (problem p14)
    ...
    (:htn
        :ordered-subtasks (and
            (serve_cocktail shot1 cocktail8)
            (serve_cocktail shot2 cocktail9)
            (serve_cocktail shot3 cocktail4)
            (serve_cocktail shot4 cocktail3)
            (serve_cocktail shot5 cocktail7)
            (serve_cocktail shot6 cocktail5)
            (serve_cocktail shot7 cocktail6)
            (serve_cocktail shot8 cocktail10)
            (serve_cocktail shot9 cocktail11)
            (serve_cocktail shot10 cocktail2)
            (serve_cocktail shot11 cocktail1)
