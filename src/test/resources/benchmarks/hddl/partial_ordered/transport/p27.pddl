(define (problem p27)
 ...
 (:htn
  :subtasks (and
   (deliver package-0 city-loc-9)
   (deliver package-1 city-loc-0)
   (deliver package-2 city-loc-8)
   (deliver package-3 city-loc-6)
   (deliver package-4 city-loc-13)
   (deliver package-5 city-loc-9)
   (deliver package-6 city-loc-1)
   (deliver package-7 city-loc-8)
   (deliver package-8 city-loc-11)
   (deliver package-9 city-loc-12)
   (deliver package-10 city-loc-4)
   (deliver package-11 city-loc-1)
   (deliver package-12 city-loc-6)
   (deliver package-13 city-loc-0)
   (deliver package-14 city-loc-5)
   )
  :ordering ( )
  :constraints ( ))
 (:init
