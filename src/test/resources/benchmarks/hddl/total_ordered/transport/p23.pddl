(define
	...
	(:htn
		:ordered-subtasks (and
		    ...
		    (deliver package_2 city_loc_7)
		    (deliver package_4 city_loc_1)
		    (deliver package_1 city_loc_8)
		    (deliver package_7 city_loc_2)
		    (deliver package_0 city_loc_3)
            (deliver package_3 city_loc_1)
            (deliver package_8 city_loc_0)
            (deliver package_9 city_loc_9)
		    (deliver package_5 city_loc_7)
		)
	)
	(:init
