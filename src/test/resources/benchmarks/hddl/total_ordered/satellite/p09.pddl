...
(define (problem p09)
    ...
    (:htn
        :ordered-subtasks (and
            (do_mission Phenomenon5 thermograph8)
            (do_mission Phenomenon5 spectrograph0)
            (do_mission Phenomenon5 image3)
            (do_mission Star6 spectrograph0)
            (do_mission Star6 spectrograph6)
            (do_mission Star6 image3)
            (do_mission Planet7 spectrograph6)
            (do_mission Planet7 infrared5)
            (do_mission Planet7 image2)
            (do_mission Phenomenon8 spectrograph6)
            (do_mission Phenomenon8 infrared5)
            (do_mission Phenomenon8 thermograph7)
            (do_mission Planet9 spectrograph6)
            (do_mission Star10 spectrograph6)
            (do_mission Star11 thermograph7)
            (do_mission Star11 image4)
            (do_mission Star11 image3)
            (do_mission Phenomenon12 image4)
            (do_mission Planet13 infrared5)
            (do_mission Planet13 spectrograph6)
            (do_mission Planet13 image2)
            (do_mission Phenomenon14 thermograph7)
            (do_mission Planet15 image3)
            (do_mission Star16 image3)
            (do_mission Star16 image4)
            (do_mission Planet18 infrared9)
            (do_mission Planet18 infrared5)
            (do_mission Planet18 thermograph7)
            (do_mission Phenomenon19 image2)
            (do_mission Phenomenon19 image4)
            (do_mission Star20 spectrograph0)
            (do_mission Phenomenon21 image4)
            (do_mission Phenomenon21 image2)
            (do_mission Phenomenon21 thermograph7)
            (do_mission Planet22 image2)
            (do_mission Planet22 spectrograph6)
            (do_mission Star23 image2)
            (do_mission Star23 infrared9)
            (do_mission Star24 spectrograph6)
            (do_mission Star24 infrared5)
            (do_turning satellite1 Phenomenon19)
        )
    )
