...
(define (domain barman)
    ...
    (:tasks
        (serve_cocktail ?s - shot ?c - cocktail)
        (serve_shot ?s - shot  ?i - ingredient)
        (get_first_ingredient ?s - shot ?c - cocktail  ?h - hand)
        (get_second_ingredient ?s - shot ?c - cocktail ?h - hand)
        (shake_cocktail ?s - container ?c - cocktail ?h - hand)
    )
