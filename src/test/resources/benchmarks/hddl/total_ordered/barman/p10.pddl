...
(define (problem p10)
    ...
    (:htn
        :ordered-subtasks (and
            ...
            (serve_cocktail shot3 cocktail9)
            (serve_cocktail shot4 cocktail1)
            (serve_cocktail shot5 cocktail3)
            (serve_cocktail shot6 cocktail6)
            (serve_cocktail shot7 cocktail8)
            (serve_cocktail shot8 cocktail2)
            (serve_cocktail shot9 cocktail11)
            (serve_cocktail shot10 cocktail7)
            (serve_cocktail shot11 cocktail4)
            (serve_cocktail shot12 cocktail11)
            (serve_shot shot13 ingredient4)
            (serve_cocktail shot14 cocktail5)
        )
    )
