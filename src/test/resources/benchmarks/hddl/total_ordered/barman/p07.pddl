...
(define (problem p07)
    ...
    (:htn
        :ordered-subtasks (and
            (serve_cocktail shot1 cocktail11)
            (serve_cocktail shot2 cocktail6)
            (serve_cocktail shot3 cocktail7)
            (serve_cocktail shot4 cocktail8)
            (serve_cocktail shot5 cocktail10)
            (serve_cocktail shot6 cocktail9)
            (serve_cocktail shot7 cocktail1)
            (serve_cocktail shot8 cocktail3)
            (serve_cocktail shot9 cocktail2)
            (serve_cocktail shot10 cocktail5)
            (serve_cocktail shot11 cocktail4)
            (serve_cocktail shot12 cocktail3)
            (serve_cocktail shot13 cocktail5)
            (serve_shot shot14 ingredient5)
            (serve_cocktail shot15 cocktail10)
        )
    )
