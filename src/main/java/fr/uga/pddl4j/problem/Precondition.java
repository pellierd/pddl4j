...
public class Precondition extends AbstractFluentDescription {
     ...
     */
    public Precondition(final TimedFluentDescription positive, final TimedFluentDescription negative) {
    ...
    public final boolean isDurative() {
        return super.isDurative() || this.hasDurativeNumericConstraints();
    }

    /**
     * Returns if the precondition has a durative numeric constraints.
     *
     * @return <code>true</code> if the precondition has a durative numeric constraints, <code>false</code> otherwise.
     */
