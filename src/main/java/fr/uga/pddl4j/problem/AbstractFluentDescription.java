...
public abstract class AbstractFluentDescription implements FluentDescription {
    ...
    public AbstractFluentDescription(final FluentDescription other) {
        this(new TimedFluentDescription(other.getPositiveTimedGoalDescription()),
            new TimedFluentDescription(other.getNegativeTimedGoalDescription()));
    }
     ...
     * @see TimedFluentDescription
     */
    public AbstractFluentDescription(final TimedFluentDescription positive, final TimedFluentDescription negative) {
     ...
     */
    public final TimedFluentDescription getPositiveTimedGoalDescription() {
     ...
     */
    public final void setPositiveTimedGoalDescription(final TimedFluentDescription positive) {
        this.positive = positive;
    }
     ...
     */
    public final TimedFluentDescription getNegativeTimedGoalDescription() {
     ...
     */
    public final void setNegativeTimedGoalDescription(final TimedFluentDescription negative) {
        this.negative = negative;
    }
    ...
    /**
     * Returns if this fluent description is durative. A fluent description is durative it has fluent with time specifier
     * (at start, at end, over-all).
     *
     * @return <code>true</code> if the fluent description is durative; <code>false</code> otherwise.
     */
