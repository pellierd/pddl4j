...
public class ProblemFactory {
     ...
     */
    private static final Logger LOGGER = LogManager.getLogger(IProblem.class);
    ...
    public IProblem encode() {
        ...
        final IProblem pb = new IProblem(domain, problem);
        pb.instantiate(this.getTraceLevel());
        return pb;
    }
